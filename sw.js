...
const ASSETS=['./','./index.html','./styles-v5.css','./ai-import-v5.css','./app-v5.js','./ai-import-v5.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./prepared-import-template.json'];
